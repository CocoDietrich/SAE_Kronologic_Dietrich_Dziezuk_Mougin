...
public class TSP_ChocoSolver_17 {
    public static void main(String[] args) {
        ...
        int max = Arrays.stream(D).flatMapToInt(Arrays::stream).max().orElse(1000) * C;
        ...
        // Solver configuration and timing
        ...
        System.out.println("Time taken with Choco Solver: " + (endTime - startTime) + "ms");
    }
}
